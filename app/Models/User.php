...
class User extends Authenticatable
{
    ...
    const ROLE_KITCHEN_RESTO = 'kitchen_resto';
    ...
    public function isKitchenResto(): bool
    {
        return $this->role === self::ROLE_KITCHEN_RESTO;
    }
    ...
    public static function deactivateInactiveAccounts(?Carbon $now = null): int
    {
        ...
        // Administrator accounts are always kept active.
        static::query()
