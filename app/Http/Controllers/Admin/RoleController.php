...
class RoleController extends Controller
{
        ...
        $users = User::query()
            ...
            ->map(function (User $user) use ($actor, $manageableRoles) {
                return [
                    ...
                    'can_toggle' => $actor->id !== $user->id
                        && ! $user->isAdmin()
                        && in_array($user->role, $manageableRoles, true),
                ];
            })
            ->values();
    ...
    {
        if ($actor->isAdmin()) {
            return ['admin', 'manager', 'cashier', 'kitchen', 'kitchen_resto', 'customer'];
        }

        return ['cashier', 'kitchen', 'kitchen_resto', 'customer'];
    }
    ...
    private function roleOptions(): array
    {
        return [
            ...
            ['value' => 'kitchen_resto', 'label' => 'Kitchen Resto'],
